...
@php
    $prefix = auth()->user()->role == 'admin' ? 'admin' : 'superadmin';
@endphp
...
<div class="container mt-5">
    ...
    <div class="card shadow-lg p-4 rounded-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <!-- FIX (DINAMIS) -->
            <a href="{{ route($prefix.'.users.create') }}" class="btn btn-primary rounded-pill px-4">
                + Buat Akun Baru
            </a>
        </div>
            ...
            <table class="table align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- DETAIL -->
                            <a href="{{ route($prefix.'.users.show', $user->id) }}"
